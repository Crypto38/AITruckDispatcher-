...
document.getElementById("sendBtn").addEventListener("click", () => {
  ...
  // Works with: "1500 pay 520 miles 80 deadhead fuel 4.25 mpg 7 aggressive"
  ...
  if (style === "aggressive") {
    ...
    brokerScript =
      ...
      "Fuel is around $" + fuelPrice.toFixed(2) + " and we’re running about " + mpg.toFixed(1) + " MPG.\n" +
      "We need about $" + counter.toFixed(0) + " all-in. Can you get us closer to that?";
  } else {
    ...
    brokerScript =
      ...
      "Fuel is about $" + fuelPrice.toFixed(2) + " and the truck averages " + mpg.toFixed(1) + " MPG.\n" +
      "Pay is $" + pay.toFixed(2) + ". Can you get us closer to $" + counter.toFixed(0) + "?";
  }
